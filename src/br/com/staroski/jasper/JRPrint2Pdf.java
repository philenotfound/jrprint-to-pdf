...
/**
 * Classe utilitria para converter arquivos JRPRINT para PDF
 * 
...
public class JRPrint2Pdf extends JFrame {
	...
	private JPanel montaPainelSaida() {
		...
		JPanel painel = new JPanel(new BorderLayout());
		painel.add(BorderLayout.NORTH, new JLabel("Arquivo PDF de saida:"));
	...
	private void trataConversao() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Arquivo convertido com sucesso!", "Concluido", JOptionPane.INFORMATION_MESSAGE);
		} catch (Throwable e) {
			e.printStackTrace();
	...
	private void trataFechamento() {
		int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente sair?", "Confirmacao", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
